package org.easytech.pelatologio.orders;
...
import org.easytech.pelatologio.suppliers.AddSupplierController;
import org.easytech.pelatologio.settings.AppSettings;
import org.easytech.pelatologio.customers.AddCustomerController;
...
//                return item.toString().toLowerCase().contains(filterText);
    ...
    public void showSupplier(ActionEvent evt) {
        ...
        Supplier selectedSupplier = dbHelper.getSelectedSupplier(order.getSupplierId());

...
public class OrderDaoImpl implements OrderDao {
    ...
    public void saveOrder(Order newOrder) {
        ...
        try (Connection conn = getConnection();
            ...
            stmt.setBoolean(4, newOrder.getCompleted() != null && newOrder.getCompleted());
            stmt.setInt(5, newOrder.getCustomerId());
            stmt.setInt(6, newOrder.getSupplierId());
            stmt.setBoolean(7, newOrder.getErgent() != null && newOrder.getErgent());
            stmt.setBoolean(8, newOrder.getWait() != null && newOrder.getWait());
            stmt.setBoolean(9, newOrder.getReceived() != null && newOrder.getReceived());
            stmt.setBoolean(10, newOrder.getDelivered() != null && newOrder.getDelivered());
            stmt.executeUpdate();
        } catch (SQLException e) {
            e.printStackTrace();
        }

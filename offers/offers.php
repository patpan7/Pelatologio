            ...
            <div class="card bank-card shadow-lg h-100 w-100">
                    <div class="card-header bg-primary text-white bank-header">
                        ...
                        <div class="card-body">
							...
							<p><strong>Ώρες:</strong> <?php echo htmlspecialchars($offer['hours']); ?></p>
                            <p><strong>Κατάσταση:</strong> <span><?php echo htmlspecialchars($offer['status']); ?></span></p>
                            <?php if (trim($offer['status']) == 'Αναμονή'): ?>
                                <form action="update_offer.php" method="post">
                                    ...
                                    <button type="submit" name="action" value="accept" class="btn btn-danger btn-sm">Απόρριψη</button>
                                </form>
                            <?php endif; ?>
                        </div>
                    </div>
